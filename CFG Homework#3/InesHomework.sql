...
SELECT @max_passengerID; -- the last passenger_ID is 86

DELETE FROM Bookings
WHERE passenger_ID = @max_passengerID;
...
-- Let's check the duration in hours of the trips
...
SELECT passenger_ID, COUNT(booking_ID) AS passenger_count_booking
FROM Bookings
